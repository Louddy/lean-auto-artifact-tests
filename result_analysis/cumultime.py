...
def cumul_solving_time(df : dict[any, list], name: str, cumul : bool):
    ...
    color_map = {
        ...
        'SaturateAssNew' : 'darkred',
        'SaturateAssOld' : 'red',
        'SaturateAesopNew' : 'magenta',
        'SaturateAesopOld' : 'black',
        # 'autoCVC5' : 'pink',
        # 'autoNative' : 'red',
        # 'autoZ3' : 'magenta',
        # 'autoCVC5' : 'pink',
    ...
    label_map = {
        ...
        'SaturateAssNew' : 'Saturate New',
        'SaturateAssOld' : 'Saturate Old',
        'SaturateAesopNew' : 'Saturate New + A',
        'SaturateAesopOld' : 'Saturate Old + A',
